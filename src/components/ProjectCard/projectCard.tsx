...
export const ProjectCard = ({
  ...
  return (
    <>
      <div
        className="bg-cta border-cta-hover hover:bg-cta-hover w-[280px] flex-shrink-0 cursor-pointer rounded-xl border p-5 shadow-md transition-all hover:shadow-lg sm:w-full"
      ...
      >
        ...
        <h3 className="text-cta-text mb-2 truncate text-lg font-bold">
          {title}
        </h3>
